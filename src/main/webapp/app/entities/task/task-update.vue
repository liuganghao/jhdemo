    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="jdemo3App.task.home.createOrEditLabel" v-text="$t('jdemo3App.task.home.createOrEditLabel')">Create or edit a Task</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jdemo3App.task.title')" for="task-title">Title</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jdemo3App.task.description')" for="task-description">Description</label>
