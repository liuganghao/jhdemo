<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jdemo3App.task.home.title')" id="task-heading">Tasks</span>
            <router-link :to="{name: 'TaskCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-task">
                ...
                <span  v-text="$t('jdemo3App.task.home.createLabel')">
                    Create new Task
                </span>
            </router-link>
        </h2>
        ...
        <div class="table-responsive" v-if="tasks">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jdemo3App.task.title')">Title</span></th>
                    <th><span v-text="$t('jdemo3App.task.description')">Description</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jdemo3App.task.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-task-heading" v-bind:title="$t('jdemo3App.task.delete.question')">Are you sure you want to delete this Task?</p>
            </div>
