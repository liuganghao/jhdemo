<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jdemo3App.country.home.title')" id="country-heading">Countries</span>
            <router-link :to="{name: 'CountryCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-country">
                ...
                <span  v-text="$t('jdemo3App.country.home.createLabel')">
                    Create new Country
                </span>
            </router-link>
        </h2>
        ...
        <div class="table-responsive" v-if="countries">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jdemo3App.country.countryName')">Country Name</span></th>
                    <th><span v-text="$t('jdemo3App.country.region')">Region</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jdemo3App.country.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-country-heading" v-bind:title="$t('jdemo3App.country.delete.question')">Are you sure you want to delete this Country?</p>
            </div>
