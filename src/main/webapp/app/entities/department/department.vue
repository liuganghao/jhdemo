<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jdemo3App.department.home.title')" id="department-heading">Departments</span>
            <router-link :to="{name: 'DepartmentCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-department">
                ...
                <span  v-text="$t('jdemo3App.department.home.createLabel')">
        ...
        <div class="table-responsive" v-if="departments">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jdemo3App.department.departmentName')">Department Name</span></th>
                    <th><span v-text="$t('jdemo3App.department.location')">Location</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jdemo3App.department.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-department-heading" v-bind:title="$t('jdemo3App.department.delete.question')">Are you sure you want to delete this Department?</p>
            </div>
